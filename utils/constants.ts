        ...
        diet_plan: {
            ...
            meal_examples: [
                ...
                },
                {
                    meal: 'Snacks',
                    example:
                        'Apple with almond butter, dairy-free yogurt with nuts',
                },
            ],
            description:
        ...
        diet_plan: {
            ...
            meal_examples: [
                ...
                },
                {
                    meal: 'Snacks',
                    example:
                        'Protein shake with fruit, Greek yogurt with honey',
                },
            ],
            description:
    ...
    },
    {
        ...
        diet_plan: {
            ...
            meal_examples: [
                ...
                {
                    meal: 'Lunch',
                    example: 'Lentil soup with mixed green salad',
                },
                {
                    meal: 'Dinner',
                ...
                },
                {
                    meal: 'Snacks',
                    example:
                        'Mixed nuts, hummus with vegetables, protein smoothie',
                },
            ],
            description:
