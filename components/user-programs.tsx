...
import { USER_PROGRAMS } from '@/utils/constants';
                ...
                <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
                    ...
                    <div className="p-8 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
                            Explore personalized fitness plans our AI assistant
                            has created for other users
                        </p>
                            ...
                            <CardContent className="px-5">
                                ...
                                <div className="mt-5 pt-5 border-t border-border">
                                    <div className="text-sm text-muted-foreground">
                                        ...
                                        {program.workout_plan.description.substring(
                                            0,
                                            120
                                        )}
                                        ...
